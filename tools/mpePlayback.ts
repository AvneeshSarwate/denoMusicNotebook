...
import type { AbletonClip, AbletonNote } from "../copiedHelpers/abletonClip.ts";
import type { CurveValue } from "../copiedHelpers/curveValue.ts";
import { curve2val } from "../copiedHelpers/curveInterpolation.ts";
